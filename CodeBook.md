...
This is a code book that describes the variables, the data, and  transformations performed to clean up the data in the course project.
...
- Read data into tables, assign column names and create one data set
